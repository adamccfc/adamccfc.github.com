  ...
  <Layout>
    <div className="home">
      <div className="home__intro">
        <h1>
          <span className="animation animation__fade-in-down">Adam</span>
          <span className="animation animation__fade-in-down animation__delay--0-25">Morgan</span></h1>
        <h2>
          <span className="white animation animation__fade-in-down animation__delay--0-5">Front end </span>
          <span className="white animation animation__fade-in-down animation__delay--0-75">developer</span>
        </h2>
      </div>
      <div className="home__contact">
        <p className="animation animation__fade-in-up animation__delay--1-5">Need a website built? Get in touch.</p>
