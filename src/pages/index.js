...
const IndexPage = () => (
  <Layout>
    <div className="home">
      ...
      <p className="home__contact animation animation__fade-in-up animation__delay--2-25">Need a website built? Get in touch.</p>
      <ul className="icons-list animation animation__fade-in-up animation__delay--2-75">
